...
#             <button class="language-button" onclick="sendMessage('Fault Reporting', this)">සිදුවීම් වාර්තා කිරීම</button>
#             <button class="language-button" onclick="sendMessage('Solar Services', this)">සෝලා සෙවා</button>
